...
# decoding parameter
recog_model=model.last3.avg.best # set a model to be used for decoding: 'model.acc.best' or 'model.loss.best'
n_average=3

# data
data=/root/Disentangled-Transformer-ASR/egs/aishell/asr1/raw_data/
data_url=www.openslr.org/resources/33

# exp tag
tag="disentangled_transformer-6-1024-lr-2" # tag for managing experiments.
