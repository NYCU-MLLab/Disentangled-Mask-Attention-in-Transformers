...
def add_arguments_transformer_common(group):
    ...
    # Disentangled mask attention
    group.add_argument(
        "--enc_clusters", default=8, type=int, help="Number of clusters in encoder"
    )
    group.add_argument(
        "--dec_clusters", default=4, type=int, help="Number of clusters in decoder"
    )
    group.add_argument(
        "--var_estimation", default=False, type=strtobool, help="With variance estimation"
    )
    group.add_argument(
        "--gmm_init", default=False, type=strtobool, help="GMM initialization"
    )
    group.add_argument(
        "--kl_weight", default=0.01, type=float, help="Loss weight of kl term"
    )
    group.add_argument(
        "--div_weight", default=1, type=float, help="Loss weight of div term"
    )
    group.add_argument(
        "--mi_weight", default=1, type=float, help="Loss weight of mi term"
    )
    group.add_argument(
        "--mu_grad", default=5, type=float, help="Gradient multiplier of cluster cluster centroids"
    )
