...
from espnet.nets.pytorch_backend.disentangled_transformer.embedding import PositionalEncoding
from espnet.nets.pytorch_backend.disentangled_transformer.encoder_layer import EncoderLayer
from espnet.nets.pytorch_backend.disentangled_transformer.layer_norm import LayerNorm
from espnet.nets.pytorch_backend.disentangled_transformer.lightconv import LightweightConvolution
from espnet.nets.pytorch_backend.disentangled_transformer.lightconv2d import LightweightConvolution2D
from espnet.nets.pytorch_backend.disentangled_transformer.multi_layer_conv import Conv1dLinear
from espnet.nets.pytorch_backend.disentangled_transformer.multi_layer_conv import MultiLayeredConv1d
from espnet.nets.pytorch_backend.disentangled_transformer.positionwise_feed_forward import (
    PositionwiseFeedForward,  # noqa: H301
)
from espnet.nets.pytorch_backend.disentangled_transformer.repeat import repeat
from espnet.nets.pytorch_backend.disentangled_transformer.subsampling import Conv2dSubsampling
from espnet.nets.pytorch_backend.disentangled_transformer.subsampling import Conv2dSubsampling6
from espnet.nets.pytorch_backend.disentangled_transformer.subsampling import Conv2dSubsampling8
    ...
    def __init__(
        ...
        self.encoders = repeat(
            ...
            lambda lnum: EncoderLayer(
                attention_dim,
                DisentangledMaskAttention(
                    *encoder_selfattn_layer_args[lnum],
                    clusters=clusters,
                    var_estimation=var_estimation,
                    mu_grad=mu_grad
                ),
