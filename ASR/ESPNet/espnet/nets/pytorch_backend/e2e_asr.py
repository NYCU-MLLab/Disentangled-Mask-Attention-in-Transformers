...
class Reporter(chainer.Chain):
    ...
    def report(self, loss_ctc, loss_att, acc, cer_ctc, cer, wer, mtl_loss,
               loss_cluster_data=None, loss_cluster_div_data=None, loss_mi_data=None):
        ...
        reporter.report({"loss_cluster_data": loss_cluster_data}, self)
        reporter.report({"loss_cluster_div_data": loss_cluster_div_data}, self)
        reporter.report({"loss_mi_data": loss_mi_data}, self)
