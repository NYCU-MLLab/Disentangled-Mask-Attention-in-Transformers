...
class DisentangledTransformerInterface(nn.Module):
    ...
    def __init__(
        ...
        if num_decoder_layers > 0:
            ...
            self.decoder = DisentangledTransformerDecoder(
...
class DisentangledTransformerEncoder(nn.Module):
...
class DisentangledTransformerDecoder(nn.Module):
