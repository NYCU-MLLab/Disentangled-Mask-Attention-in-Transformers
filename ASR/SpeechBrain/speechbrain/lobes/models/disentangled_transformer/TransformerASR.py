...
from speechbrain.lobes.models.disentangled_transformer.Transformer import (
    DisentangledTransformerInterface,
    get_lookahead_mask,
...
class DisentangledTransformerASR(DisentangledTransformerInterface):
